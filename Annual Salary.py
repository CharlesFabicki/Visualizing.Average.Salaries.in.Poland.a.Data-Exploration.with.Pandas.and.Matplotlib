...
# Chart 1: Year from 1950 to 1989 (wider)
plt.subplot(3, 1, 1)
bars1 = plt.bar(data_1950_1989['Year'], data_1950_1989['Annual Salary'], color='blue')
plt.title('Annual Salary: 1950-1989')
...
plt.subplot(3, 1, 2)
bars2 = plt.bar(data_1990_1994['Year'], data_1990_1994['Annual Salary'], color='green')
plt.title('Annual Salary: 1990-1994')
...
plt.ylim(0, 8000000)  # Set the upper limit to 8 million
plt.yticks([0, 10000000, 20000000, 30000000, 40000000, 50000000, 60000000, 70000000, 80000000],
           ['0', '10M', '20M', '30M', '40M', '50M', '60M', '70M', '80M'])

# Chart 3: Year from 1995 to 2022
plt.subplot(3, 1, 3)
bars3 = plt.bar(data_1995_2022['Year'], data_1995_2022['Annual Salary'], color='orange')
plt.title('Annual Salary: 1995-2022')
plt.xlabel('Year')
